...
public final class BlendComposite {
    ...
    private final static int NORM_BYTE = 0xFF; // 255
    private final static int NORM_BYTE7 = 0x7F; // 127
    private final static int NORM_ALPHA = (NORM_BYTE * NORM_BYTE7); // 32385 = 255 x 127
    private final static int NORM_GAMMA = (1 << 15) - 1; // 32767
    ...
    /* members */
    private final BlendComposite.BlendingMode mode;
    ...
    public BlendingContext createContext() {
        ...
        return blendContextThreadLocal.get().init(this);
    }
    ...
    static final class BlendingContext {
        ...
        BlendingContext init(final BlendComposite composite) {
        ...
        public void compose(final int srcRGBA, final Raster srcIn,
